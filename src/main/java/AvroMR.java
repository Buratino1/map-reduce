...
public class AvroMR extends Configured  implements Tool
{
    ...
    public int run(String[] args) throws Exception
    {
        ...
        File avrofile = new File("/home/cloudera/ganer/ufo.avsc") ;

        System.out.println("avro file readed v2");

        Schema input_schema = Schema.parse(avrofile) ;
